    ...
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            <div className="relative z-20 flex items-center text-lg font-medium">
              <img
                ...
                width="30"
              ></img>
              <h1 className="flex items-center font-semibold text-[1em] text-[#1a2b3b]">
                AcademicScope
              </h1>
            </div>
          </motion.div>
          ...
          >
            Melihat Progres <br />
            Semakin <span className="text-[#407BBF]"> Mudah</span>
          ...
          >
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Akses penuh ke platform kami, termasuk pertanyaan dan solusi.
              </p>
            </div>
            <div className="w-1/2">
              <h2 className="flex items-center font-semibold text-[1em] text-[#1a2b3b]">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Pantau dan tingkatkan progres mahasiswa dengan efektif.
              </p>
            </div>
            ...
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Gunakan alat analisis untuk wawasan kinerja mahasiswa.
              </p>
            </div>
          </motion.div>
        ...
        <div
          className="fixed top-0 right-0 w-[80%] md:w-1/2 h-screen bg-[#000000]/20"
          style={{
            clipPath:
        ...
        <div className="fixed bottom-0 z-20 w-full h-[60px] bg-[#2b2f4e] flex flex-row items-center justify-evenly">
          <p className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap flex flex-row">
            Crafted with passion by
            <Link
              href="https://www.instagram.com/nathanndk/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap hover:text-white mx-2 flex flex-row"
            >
              <i className="fab fa-twitter">Nathan</i>
            </Link>
            <Link
              href="https://www.instagram.com/ynt.rian/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap hover:text-white mx-2 flex flex-row"
            >
              <i className="fab fa-twitter">Yanto</i>
            </Link>{" "}
            <Link
              href="https://www.instagram.com/baswaraf/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap hover:text-white mx-2 flex flex-row"
            >
              <i className="fab fa-twitter">Fikbas</i>
            </Link>{" "}
            <Link
              href="https://www.instagram.com/ardian.fw/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap hover:text-white mx-2 flex flex-row"
            >
              <i className="fab fa-twitter">Ardian</i>
            </Link>{" "}
          </p>
          <ModeToggle />
        </div>
